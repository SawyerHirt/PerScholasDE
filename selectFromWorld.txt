...
/*
1. Read the notes about this table. Observe the result of running this SQL 
...
/*
2.
How to use WHERE to filter records. Show the name for the countries that have
a population of at least 200 million. 200 million is 200000000, there are 
eight zeros.
*/
...
sq km or it has a population of more than 250 million. Show the countries that
are big by area or big by population. Show name, population and area.
*/
...
/*
8.
Exclusive OR (XOR). Show the countries that are big by area or big by
...
For South America show population in millions and GDP in billions both to
2 decimal places.
*/
...
1000. Show per-capita GDP for the trillion dollar countries to the
nearest $1000.
*/
...
of characters. You can use the LENGTH function to find the number of characters
in a string
*/
...
your results. The query shown misses countries like Bahamas and Belarus 
